                ...
                if (field.Type == TType.List) {
                  {
                    ...
                    {
                      ByteCodeObject _elem109;
                      _elem109 = new ByteCodeObject();
                      _elem109.Read(iprot);
                      ByteCodeObjects.Add(_elem109);
                    }
                    iprot.ReadListEnd();
                  }
                } else { 
        ...
        try
        {
          ...
          if (ByteCodeObjects != null && __isset.byteCodeObjects) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (ByteCodeObject _iter110 in ByteCodeObjects)
              {
