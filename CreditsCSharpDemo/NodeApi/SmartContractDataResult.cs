              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    SmartContractMethod _elem60;
                    _elem60 = new SmartContractMethod();
                    _elem60.Read(iprot);
                    Methods.Add(_elem60);
                  }
                  iprot.ReadListEnd();
      ...
      try
      {
        ...
        if (Methods != null && __isset.methods) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (SmartContractMethod _iter65 in Methods)
            {
              _iter65.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (Variables != null && __isset.variables) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter66 in Variables.Keys)
            {
              oprot.WriteString(_iter66);
              Variables[_iter66].Write(oprot);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
