              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  {
                    sbyte _key14;
                    CumulativeAmount _val15;
                    _key14 = iprot.ReadByte();
                    _val15 = new CumulativeAmount();
                    _val15.Read(iprot);
                    BalancePerCurrency[_key14] = _val15;
                  }
                  iprot.ReadMapEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (BalancePerCurrency != null && __isset.balancePerCurrency) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (sbyte _iter16 in BalancePerCurrency.Keys)
            {
              oprot.WriteByte(_iter16);
              BalancePerCurrency[_iter16].Write(oprot);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
